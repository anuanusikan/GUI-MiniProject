...
function openCategoriesAndScroll() {
  filterStore.openCategories()
    ...
    <div class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4">
        <div class="h-16 flex items-center gap-3">
          ...
          <a
            href="#top"
            class="text-xl sm:text-2xl font-bold text-indigo-700 tracking-tight whitespace-nowrap"
          ...
          <form class="flex-1 flex items-center" @submit.prevent="onSearch">
            <div class="w-full max-w-2xl mx-auto hidden sm:block">
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full pl-10 pr-24 py-2 rounded-full border border-gray-200 bg-white
            ...
            <button
              type="button"
              class="sm:hidden ml-auto p-2 rounded-md hover:bg-gray-100 transition text-gray-700"
              aria-label="Search"
              @click="toggleMenu"
            >
          ...
          <div class="flex items-center gap-1 sm:gap-2">
            ...
            <button class="p-2 rounded-md hover:bg-gray-100 transition text-gray-700 relative" aria-label="Cart">
              ...
              <span class="absolute -top-1 -right-1 text-[10px] leading-none px-1.5 py-1 rounded-full bg-indigo-600 text-white">
                2
              </span>
            </button>
    ...
    <div class="bg-[#7a1f1f] text-white">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="h-12 hidden lg:flex items-center justify-center gap-10 text-sm font-semibold tracking-wide">
          <a
            href="#top"
            class="hover:text-gray-200 hover:underline underline-offset-4 transition"
            @click="filterStore.closeCategories()"
          >
            Home
          </a>
...
>
  Categories
     ...
     <button
  type="button"
  class="text-left px-3 py-2 rounded-md hover:bg-white/10 transition"
  @click="openCategoriesAndScroll(); closeMenu()"
>
  Categories
</button>
